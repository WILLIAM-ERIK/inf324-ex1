...
<!-- Cuerpo -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="#!">INST. INV. DE INFORMATICA</a></li>
                    </ul>
                </div>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <header class="py-5 bg-image-full" style="background-image: url('../imagenes/08 FONDO INV.JPG')">
            <div class="text-center my-5">
                ...
                <h1 class="text-white fs-1 fw-bolder">INSTITUTO DE INVESTIGACION DE INFORMATICA</h1>
        ...
        <section class="py-5">
            <div class="container my-5">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <h2 style="color:#1F618D">INSTITUTO DE INVESTIGACION DE INFORMATICA</h2>
